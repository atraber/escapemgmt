...
export class RoomsComponent {
  ...
  addRoom(): void {
    const dialogRef = this.dialog.open(RoomCreateDialog, {width : '500px'});
  }
  ...
  deleteRoomDialog(room): void {
    const dialogRef =
        this.dialog.open(RoomsDeleteDialog, {width : '500px', data : room});
...
export class RoomsDeleteDialog {
  constructor(public dialogRef: MatDialogRef<RoomsDeleteDialog>,
